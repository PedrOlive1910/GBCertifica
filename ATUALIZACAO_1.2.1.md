# Atualização para o GBcertifica 1.2.1
...
git status
git add .
git commit -m "release: GBcertifica v1.2.1"
git push origin main
git tag -a v1.2.1 -m "GBcertifica 1.2.1"
...
Na VPS, mantenha `APP_CONFIG=production`, atualize `APP_VERSION=1.2.1`, instale
